...
class _FlutterSwitchState extends State<FlutterSwitch> with SingleTickerProviderStateMixin {
  ...
  Widget get _activeText {
    if (widget.showOnOff) {
      return AppText( text: widget.activeText ?? "On", style: TextStyle(color: widget.activeTextColor, fontWeight: _activeTextFontWeight, fontSize: widget.valueFontSize));
    }
  ...
  Widget get _inactiveText {
    if (widget.showOnOff) {
      return AppText( text: widget.inactiveText ?? "Off", style: TextStyle(color: widget.inactiveTextColor, fontWeight: _inactiveTextFontWeight, fontSize: widget.valueFontSize), textAlign: TextAlign.right);
    }
