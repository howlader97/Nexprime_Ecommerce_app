              ...
              child: Column(
                ...
                children: [
                            ...
                            child: InkWell(
                              ...
                              child: AnimatedContainer(
                                ...
                                decoration: BoxDecoration(
                                  color: isCustomer ? AppColors.instance.green : AppColors.instance.white100,
                                  border: Border.all(color: isCustomer ? AppColors.instance.green : AppColors.instance.dark300),
                    ...
                    children: [
                      Expanded(
                        ...
                        child: AppInputWidgetTwo(
                          ...
                          onTap: () {
                            appImageUserTake(
                              callBack: (v) {
                                ...
                                fontImageController.text = v.split("/").last;
                              },
                            );
                          },
                          validator: (String? value) {
                          ...
                          title: "Resident Card",
                          hintText: "Upload front side photo",
                        ...
                        children: [
                          Expanded(
                            ...
                            child: AppInputWidgetTwo(
                              ...
                              onTap: () {
                                appImageUserTake(
                                  callBack: (v) {
                                    ...
                                    backImageController.text = v.split("/").last;
                                  },
                                );
                              },
                              validator: (String? value) {
                              ...
                              hintText: "Upload back side photo",
                            ),
                          ),
                          Gap(width: AppSize.size.width * 0.02),
                          Expanded(
                                ...
                                onTap: () {
                                  appImageUserTake(
                                    callBack: (v) {
                                      ...
                                      storeImageController.text = v.split("/").last;
                                    },
                                  );
                                },
                                validator: (String? value) {
                  ...
                  Center(
                    child: Wrap(
                      children: [
                        AppText(text: "Already have an account?", fontFamily: AppConstant.instance.openSans),
                        Gap(width: 10),
                        InkWell(
                          onTap: () {
                          ...
                          overlayColor: WidgetStatePropertyAll(Colors.transparent),
                          child: AppText(text: "Sign In", fontFamily: AppConstant.instance.openSans, fontWeight: FontWeight.w600),
                        ),
                      ],
                    ),
                  ),
